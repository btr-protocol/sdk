...
/** ExternalOracle feeds per pool asset. nxrSymbol = NX Rates pair for USD; stables fall back to ~1 on miss. */
export const SEPOLIA_ORACLE_FEEDS: SepoliaFeed[] = [
  ...
  { name: 'USDT-USDC', feedId: '0x61c6b9fad453a43df30b315406e2f3ba288db5371fc3c14837ebbc6845537649', nxrSymbol: 'USDT-USDC', token: SEPOLIA_TOKENS['USDT']!, symbol: 'USDT' },
  { name: 'USDE-USDC', feedId: '0x630c6d77e18874d430497b148ee225347a8b6e50e496314cf21fd2e1f5593737', nxrSymbol: 'USDE-USDC', token: SEPOLIA_TOKENS['USDE']!, symbol: 'USDE' },
  { name: 'USDS-USDC', feedId: '0xb6029a46e36f5f278efa1ef9fdc4c90cd551020035cb96d0dc0e32e357cd8b28', nxrSymbol: 'USDS-USDC', token: SEPOLIA_TOKENS['USDS']!, symbol: 'USDS' },
  { name: 'DAI-USDC', feedId: '0x7a46c181ee94097ac0df58994c600bc0ef430068a835e01e794cb257f5596d8d', nxrSymbol: 'DAI-USDC', token: SEPOLIA_TOKENS['DAI']!, symbol: 'DAI' },
  { name: 'USD1-USDC', feedId: '0xd1bf5f81612e80fe9dcee9a3864ceebb55f1b8e60e80a3873c0ef6e425738950', nxrSymbol: 'USD1-USDC', token: SEPOLIA_TOKENS['USD1']!, symbol: 'USD1' },
  { name: 'USDG-USDC', feedId: '0xc5dae82a0540fe49220e35a55370c8b7f4626687789c3861598540ee6e5ba95d', nxrSymbol: 'USDG-USDC', token: SEPOLIA_TOKENS['USDG']!, symbol: 'USDG' },
  { name: 'PYUSD-USDC', feedId: '0x5ce7bdb929429721a41bda720bd1b2c3a19a975af5dde19d4fb97c314f5ff352', nxrSymbol: 'PYUSD-USDC', token: SEPOLIA_TOKENS['PYUSD']!, symbol: 'PYUSD' },
  { name: 'RLUSD-USDC', feedId: '0x059e09b4f6fd64f9e0e42d7923d95e1b880368066a03447d27bb65f68aaba499', nxrSymbol: 'RLUSD-USDC', token: SEPOLIA_TOKENS['RLUSD']!, symbol: 'RLUSD' },
  ...
  { name: 'USDF-USDC', feedId: '0xa7fce6c9ae3f556f797b660d12480c4c7a988a6b65f02fda8692799022dd4e51', nxrSymbol: 'USDF-USDC', token: SEPOLIA_TOKENS['USDF']!, symbol: 'USDF' },
  { name: 'U-USDC', feedId: '0x23ebdf3e1ac943e6d8c61a72f52d7fb0ed34b6fff0d9d92e4764988f86b59e64', nxrSymbol: 'U-USDC', token: SEPOLIA_TOKENS['U']!, symbol: 'U' },
  { name: 'GHO-USDC', feedId: '0x11a05afba5a4531eb8ca4a6b92c376533319dcf882e1176b8f1285e18c4d7105', nxrSymbol: 'GHO-USDC', token: SEPOLIA_TOKENS['GHO']!, symbol: 'GHO' },
  { name: 'TUSD-USDC', feedId: '0xe5f40e8df2a3159d68952252a5a53a72026469a65978db0268fa750051b9bac3', nxrSymbol: 'TUSD-USDC', token: SEPOLIA_TOKENS['TUSD']!, symbol: 'TUSD' },
  { name: 'USDTB-USDC', feedId: '0x8d419507772b2abbabf61c38e592d6fa90dcad64f6556deb337050d1cf0de803', nxrSymbol: 'USDTB-USDC', token: SEPOLIA_TOKENS['USDTB']!, symbol: 'USDTB' },
  { name: 'FDUSD-USDC', feedId: '0x655c99253ef593e835512bb246d331cc60b176793087e16fd604b2fdc066e5f4', nxrSymbol: 'FDUSD-USDC', token: SEPOLIA_TOKENS['FDUSD']!, symbol: 'FDUSD' },
  { name: 'AUSD-USDC', feedId: '0x8bb9c388de78e600c772353b07e9b8b149abfd3adb2f0ce971a41d86d2fbdcee', nxrSymbol: 'AUSD-USDC', token: SEPOLIA_TOKENS['AUSD']!, symbol: 'AUSD' },
  ...
  { name: 'EURC-USDC', feedId: '0x7b48a1509b4849707b3c406b7c1866cabb0938d87b5e0b0842df4b098c693575', nxrSymbol: 'EURC-USDC', token: SEPOLIA_TOKENS['EURC']!, symbol: 'EURC' },
];
...
export const SEPOLIA_REF_MARKS_USD: Record<string, number> = {
  ...
  WETH: 3800, WBTC: 118_000, cbBTC: 118_000, BNB: 1100, XAUT: 3350, PAXG: 3350, EURC: 1.17,
};
