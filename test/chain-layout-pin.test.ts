 ...
 * the compiled contract sources, i.e. against the SOURCE. Neither can see a pool whose bytecode predates that
 ...
 * Deliberately independent of compiled output: an artifact cannot witness what is deployed.
 *
